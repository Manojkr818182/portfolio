            ...
            <div className='container mx-auto flex justify-between items-center'>
                <div>
                    <a href='#' className='text-3xl font-bold text-white'>
                        Manoj
                        <span className='text-orange'>Kumar</span>
                ...
                <div className='hidden md:flex space-x-10'>
                    <a href='#home' className='relative text-white/80 transition duration-300 hover:text-orange group' >
                        <span>Home</span>
                        <span className='absolute left-0  -bottom-1 w-0 h-0.5 bg-orange transition-all duration-3000 group-hover:w-full'></span>
                    </a>
                    ...
                    <a href='#project' className='relative text-white/80 transition duration-300 hover:text-orange group' >
                        <span>Project</span>
                        <span className='absolute left-0  -bottom-1 w-0 h-0.5 bg-orange transition-all duration-3000 group-hover:w-full'></span>
                    </a>
                    ...
                    }
                    {
                        showMenu && (
                            <div className='md:hidden mt-4 bg-dark-300 h-screen rounded-lg p-4 flex flex-col space-y-4 text-center justify-center'>
                                    ...
                                    <a  onClick={() => setShowMenu(!showMenu)} href='#project' className='relative text-white/80 transition duration-300 hover:text-orange group' >
                                        <span>Project</span>
                                        <span className='absolute left-0  -bottom-1 w-0 h-0.5 bg-orange transition-all duration-3000 group-hover:w-full'></span>
                                    </a>
